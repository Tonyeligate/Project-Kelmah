...
export const enhancedTestUser = {
  ...
  skills: [
    { 
      ...
      certified: true, 
      yearsExperience: 8,
      description: 'Complete electrical system installation for residential and commercial buildings'
    },
    { 
      ...
      certified: true, 
      yearsExperience: 7,
      description: 'Diagnosis and repair of electrical faults and circuit issues'
    },
    { 
  ...
  recentJobs: [
    {
      ...
      earnings: 2800,
      rating: 5,
      feedback: 'Excellent work, very professional and completed ahead of schedule.'
    },
    {
      id: 'job-002',
  ...
  reviews: [
    {
      ...
      client: 'Sarah Mitchell',
      rating: 5,
      comment: 'Kwame is extremely professional and skilled. Completed our home rewiring project efficiently and safely.',
      date: '2024-01-12',
    ...
    },
    {
      ...
      client: 'Tech Solutions Ltd',
      rating: 5,
      comment: 'Outstanding solar panel installation. Kwame explained everything clearly and delivered exceptional results.',
      date: '2024-01-18',
...
export const generateUserSpecificMockData = (user = enhancedTestUser) => ({
  ...
  dashboardMetrics: {
    ...
    activeJobs: user.recentJobs.filter(j => j.status === 'in-progress').length,
  ...
  relevantJobs: [
    {
      ...
      description: 'Complete electrical installation for new 3-story commercial building in Accra.',
      budget: 15000,
      location: 'Airport City, Accra',
      urgency: 'medium',
    ...
    },
    {
      ...
      description: 'Quarterly maintenance for solar panel installation at residential complex.',
      budget: 2500,
      location: 'East Legon, Accra', 
      urgency: 'low',
  ...
  appointments: [
    {
      ...
      startTime: new Date(Date.now() + 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000).toISOString(),
      endTime: new Date(Date.now() + 24 * 60 * 60 * 1000 + 11 * 60 * 60 * 1000).toISOString(),
      status: 'confirmed',
