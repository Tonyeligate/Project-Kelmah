...
const EmptyState = ({
  ...
  const typeConfigs = {
    ...
    jobs: {
      ...
      defaultHint:
        'Post one job first, then review applications from your dashboard.',
    },
    applications: {
      icon: SearchOff,
      defaultTitle: 'No Applications',
      defaultDescription:
        "You don't have any applications yet. Start applying to jobs to see them here.",
      defaultHint:
        'Use one trade filter first, then expand search location if needed.',
    },
    workers: {
      icon: PersonOff,
    ...
    search: {
      ...
      defaultHint:
        'Start broad, then narrow by location, rate, or availability.',
    },
    error: {
      icon: ErrorOutline,
      ...
      defaultHint:
        'If this persists, refresh the page and try again in a moment.',
    },
    messages: {
      icon: InboxOutlined,
    ...
    notifications: {
      ...
      defaultHint:
        'New alerts will appear here when jobs, messages, or payments update.',
    },
  };
