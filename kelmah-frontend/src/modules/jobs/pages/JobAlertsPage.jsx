  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (cancelled) return;
        setError(
          'Could not load alert settings. You can update and save again.',
        );
      } finally {
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          sx={{ mb: 1.25, display: { xs: 'none', md: 'block' } }}
        >
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      color="secondary"
                      inputProps={{
                        'aria-label': 'Show job alerts inside the app',
                      }}
                    />
                  }
