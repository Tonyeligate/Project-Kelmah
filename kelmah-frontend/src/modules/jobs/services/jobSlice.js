...
const jobSlice = createSlice({
    ...
    reducers: {
        ...
        clearSavedError: (state) => { state.savedError = null; }
    },
...
export const { setFilters, clearJobError, setCurrentPage, setJobs, setLoading, setError, setSavedFilters, clearSavedError } = jobSlice.actions;
