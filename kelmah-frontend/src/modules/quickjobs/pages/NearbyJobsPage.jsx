...
const NearbyJobsPage = () => {
  ...
  const [quoteEstimatedDuration, setQuoteEstimatedDuration] =
    useState('half_day');
  ...
  const fetchJobs = useCallback(
    async (pos) => {
      ...
      try {
        ...
        setError(
          'Unable to load nearby jobs. Check your connection and try again.',
        );
      } finally {
        setLoading(false);
      }
        ...
        {location && (
          ...
          >
            ...
            {categoryFilter && (
              <Chip
                label={
                  SERVICE_CATEGORIES.find((c) => c.id === categoryFilter)
                    ?.name || 'Category'
                }
                size="small"
                sx={{ fontWeight: 700 }}
                ...
                >
                  <CardContent sx={{ p: { xs: 1.5, md: 2 } }}>
                    ...
                    >
                      ...
                      <Chip
                        label={
                          URGENCY_LEVELS.find((l) => l.id === job.urgency)
                            ?.name || 'Soon'
                        }
            ...
            {quoteSuccess ? (
              ...
              <Box sx={{ pt: 1 }}>
                ...
                <TextField
                  ...
                  helperText={
                    quoteAmount && parseFloat(quoteAmount) >= 25
