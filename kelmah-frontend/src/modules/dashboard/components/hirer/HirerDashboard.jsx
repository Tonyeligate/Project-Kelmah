...
const HirerDashboard = ({ user }) => {
  ...
  const statistics = [
    {
      title: 'Active Jobs',
      value: user.stats?.activeJobs || '0',
      color: '#4CAF50',
    },
    {
      title: 'Pending Applications',
      value: user.stats?.pendingApplications || '0',
      color: '#FF9800',
    },
    {
      title: 'Active Contracts',
      value: user.stats?.activeContracts || '0',
      color: '#2196F3',
    },
    {
      title: 'Total Spent',
          ...
          >
            <CardContent sx={{ p: 3 }}>
              ...
              <Typography variant="body2" color="textSecondary" paragraph>
                Search our database of verified professionals for your next
                project.
              </Typography>
              <Button
                component={RouterLink}
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <CardContent sx={{ p: 3 }}>
              ...
              <Typography variant="body2" color="textSecondary" paragraph>
                Complete business verification to attract more qualified workers
                and build trust.
              </Typography>
              <Button
                component={RouterLink}
