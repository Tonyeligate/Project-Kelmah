...
const HirerStatsCard = React.memo(
  ({ title, value, change, icon, color, loading, subtitle }) => (
    <Card
      sx={{
        borderRadius: 3,
        overflow: 'hidden',
        ...
        '&::before': {
          ...
          bottom: 0,
          background:
            'url("data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="white" fill-opacity="0.08"%3E%3Cpath d="M30 30c0-8.3-6.7-15-15-15s-15 6.7-15 15 6.7 15 15 15 15-6.7 15-15zm15 0c0-8.3-6.7-15-15-15s-15 6.7-15 15 6.7 15 15 15 15-6.7 15-15z"/%3E%3C/g%3E%3C/svg%3E")',
          pointerEvents: 'none',
        },
      }}
    >
...
const HirerActionCard = React.memo(
  ({ title, description, icon, onClick, gradient, featured }) => (
    <Card
      sx={{
        borderRadius: 3,
        cursor: 'pointer',
    ...
    >
      <CardContent sx={{ textAlign: 'center', py: 3 }}>
        <Box sx={{ fontSize: 48, mb: 2, opacity: 0.9 }}>{icon}</Box>
...
const EnhancedHirerDashboard = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useSelector((state) => state.hirerDashboard || {});
          ...
          >
            ...
            {(!data?.metrics?.totalJobs || data.metrics.totalJobs === 0) && (
              ...
              >
                ...
                >
                  <strong>Get started!</strong> Post your first job to connect
                  with talented workers across Ghana.
                </Alert>
              </motion.div>
            )}
                      ...
                      <List dense>
                        {recentApplications.slice(0, 3).map((app, index) => (
                          <ListItem
                            ...
                            onClick={() =>
                              navigate(`/hirer/applications/${app.id}`)
                            }
                          >
                            <ListItemAvatar>
                              <Avatar
