...
class DashboardService {
    ...
    async getRecentMessages() {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/dashboard/messages`, {
                headers: { Authorization: `Bearer ${this.token}` }
            });
            return response.data.data;
        } catch (error) {
    ...
    async getQuickActions() {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/dashboard/quick-actions`, {
                headers: { Authorization: `Bearer ${this.token}` }
            });
            return response.data.data;
        } catch (error) {
    ...
    async getNotificationsSummary() {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/dashboard/notifications-summary`, {
                headers: { Authorization: `Bearer ${this.token}` }
            });
            return response.data.data;
        } catch (error) {
