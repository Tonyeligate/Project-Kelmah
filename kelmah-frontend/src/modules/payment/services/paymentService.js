...
const MOCK_TRANSACTIONS = [
  {
    ...
    status: 'completed',
    type: 'received',
    description: 'Milestone payment: Kitchen Design',
    from: 'John Smith',
    jobId: 'job-101',
  },
  {
    ...
    status: 'completed',
    type: 'received',
    description: 'Milestone payment: Initial Inspection',
    from: 'Sarah Johnson',
    jobId: 'job-102',
  },
  {
    ...
    status: 'pending',
    type: 'received',
    description: 'Milestone payment: Materials Purchase',
    from: 'John Smith',
    jobId: 'job-101',
  },
  {
