...
const paymentService = {
  ...
  deletePaymentMethod: async (methodId) => {
    const { data } = await paymentServiceClient.delete(
  ...
  refundEscrow: async (escrowId) => {
    const { data } = await paymentServiceClient.post(
      `/api/payments/escrows/${escrowId}/refund`,
    );
    return data;
  },
  ...
  getMtnMoMoTransactionStatus: async (referenceId) => {
    const { data } = await paymentServiceClient.get(
      `/api/payments/mtn-momo/status/${referenceId}`,
    );
    return data;
  },
  ...
  getVodafoneCashTransactionStatus: async (referenceId) => {
    const { data } = await paymentServiceClient.get(
      `/api/payments/vodafone-cash/status/${referenceId}`,
    );
    return data;
  },
  ...
  getAirtelTigoTransactionStatus: async (referenceId) => {
    const { data } = await paymentServiceClient.get(
      `/api/payments/airteltigo/status/${referenceId}`,
    );
    return data;
  },
  ...
  getBankTransferStatus: async (transferId) => {
    const { data } = await paymentServiceClient.get(
      `/api/payments/bank-transfer/status/${transferId}`,
    );
    return data;
  },
  ...
  getPayoutStatus: async (payoutId) => {
    const { data } = await paymentServiceClient.get(
      `/api/payments/payout/status/${payoutId}`,
    );
    return data;
  },
};
