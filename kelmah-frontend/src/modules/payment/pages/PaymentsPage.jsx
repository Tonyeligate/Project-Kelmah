...
import { Add as AddIcon, CreditCard as CreditCardIcon, MoreVert as MoreVertIcon } from '@mui/icons-material';
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 4 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                <Typography variant="h4" sx={{ color: 'secondary.main' }}>Payments</Typography>
                <Button
                ...
                >
                    <MenuItem component={RouterLink} to="/payment/methods" onClick={handleMenuClose}>
                        Manage Payment Methods
                    </MenuItem>
                    <MenuItem component={RouterLink} to="/payment/bill" onClick={handleMenuClose}>
                        View Bills
                    </MenuItem>
                </Menu>
            </Box>
            ...
            <Grid container spacing={3}>
                ...
                {/* Main Content */}
                <Grid item xs={12}>
                    <Paper sx={{ width: '100%', border: '1px solid', borderColor: 'secondary.main', borderRadius: 2 }}>
                        <Tabs
                            value={selectedTab}
