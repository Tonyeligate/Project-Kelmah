      ...
      >
        ...
        >
          <Box>
            ...
            >
              Track transactions, review wallet activity, and manage billing
              safely.
            </Typography>
          </Box>
          <Button
        ...
        {slowLoading && (
          <Alert severity="info" sx={{ mb: 2 }}>
            Payments are taking longer than usual to load. The service may be
            waking up. You can wait a bit more or retry now.
          </Alert>
        )}
          ...
          {isMobile && (
            <Grid item xs={12}>
              ...
              >
                <Chip
                  size="small"
                  label={`Balance ${currencyFormatter.format(walletBalance || 0)}`}
                  sx={{ fontWeight: 700 }}
                />
                <Chip
                  size="small"
                  variant="outlined"
                  label={`${Array.isArray(transactions) ? transactions.length : 0} txns`}
                  sx={{ fontWeight: 700 }}
                />
              </Stack>
            </Grid>
            ...
            >
              ...
              {walletMissing && !error && (
                <Alert severity="info" sx={{ mt: 2 }}>
                  Your wallet is empty because it has not been provisioned yet.
                  It will be created automatically when you add funds or receive
                  a payout.
                </Alert>
              )}
            </Paper>
                  ...
                  <>
                    ...
                    {!loading &&
                      ...
                      transactions.length === 0 && (
                        <Alert severity="info" sx={{ mt: 2 }}>
                          No transactions yet. Once deposits, withdrawals, or
                          escrow events occur, they will appear here.
                        </Alert>
                      )}
                    {pageCount > 1 && (
                      <Box
