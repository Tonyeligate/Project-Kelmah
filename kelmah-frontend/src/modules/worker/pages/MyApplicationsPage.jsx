...
const MyApplicationsPage = () => {
  ...
  const handleComposeMessage = () => {
    ...
    const draftPayload = {
      ...
      applicationId:
        selectedApplication?.id || selectedApplication?._id || null,
      jobId:
        selectedApplication?.job?._id || selectedApplication?.job?.id || null,
      jobTitle:
    ...
    return (
      ...
      >
        ...
        >
                    ...
                    <Box>
                      ...
                      >
                        <Box sx={{ flex: 1 }}>
                          ...
                          >
                            {application.job?.hirer?.firstName
                              ? `${application.job.hirer.firstName} ${application.job.hirer.lastName || ''}`.trim()
                          ...
                          >
                            Location: {getApplicationLocationLabel(application)}{' '}
                            | Applied {getApplicationDateLabel(application)}
                          </Typography>
                        </Box>
                        <Chip
                      ...
                      <Box sx={{ display: 'flex', gap: 1 }}>
                        <Button
                          ...
                          onClick={(event) =>
                            handleOpenDetails(application, event)
                          }
                        >
                          Review
                        </Button>
                        <Button
                          ...
                          onClick={(event) =>
                            handleOpenMessage(application, event)
                          }
                        >
                          Message hirer
                        </Button>
          ...
          <Box
            sx={{ height: `calc(84px + env(safe-area-inset-bottom, 0px))` }}
          />
        </Box>
      </PageCanvas>
    );
    ...
    >
      <Container sx={{ py: { xs: 2, md: 4 } }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          Track each application status and open messages with hirers from one
          place.
        </Typography>
        ...
        >
          {selectedApplication && (
            <>
              <DialogTitle id="application-details-dialog-title">
                Application Details
              </DialogTitle>
              <DialogContent>
        ...
        >
          {selectedApplication && (
            <>
              <DialogTitle id="application-message-dialog-title">
                Message about {selectedApplication.job?.title || 'Application'}
              </DialogTitle>
              <DialogContent>
                ...
                <Typography variant="body2" color="text.secondary" paragraph>
                  Write your message below. You'll be taken to the Messages page
                  to select the conversation and confirm before it's sent.
                </Typography>
                <TextField
                  autoFocus
                  margin="dense"
