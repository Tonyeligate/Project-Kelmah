...
const WorkerProfileEditPage = () => {
  ...
  const [undoSkillSnackbar, setUndoSkillSnackbar] = useState({
    open: false,
    skill: null,
  });
  ...
  useEffect(() => {
    ...
    dispatch(fetchWorkerProfile(id))
      ...
      .then((profile) => {
        ...
        setImagePreview(
          profile.profilePicture || profile.profileImageUrl || null,
        );
      ...
      try {
        ...
        if (data) {
          ...
          setFormData((prev) => ({
            ...
            availableHours:
              mappedAvailability.availableHours || prev.availableHours,
        ...
        setSnackbar({
          open: true,
          message:
            'Could not load your availability settings. The form may show defaults.',
          severity: 'warning',
        });
      }
    })();
  ...
  const handlePortfolioImageChange = (e, index) => {
    ...
    if (file) {
      ...
      if (file.size > 5 * 1024 * 1024) {
        setSnackbar({
          open: true,
          message: 'Portfolio image must be under 5 MB.',
          severity: 'error',
        });
        return;
      }
          ...
          <>
            <Box sx={{ mb: { xs: 2, md: 4 } }}>
              ...
              <Typography variant="body1" color="text.secondary">
                Complete your profile details, then save to help hirers trust
                your experience.
              </Typography>
              <Alert severity="info" sx={{ mt: 2 }}>
                ...
                >
                  Quick profile checklist ({completedChecklistCount}/
                  {checklistItems.length})
                </Typography>
                <Typography variant="body2" sx={{ mb: 0.5 }}>
                  Fill the core fields first, then save. Optional sections can
                  wait.
                </Typography>
              ...
              >
                ...
                >
                  <Typography variant="body2" color="text.secondary">
                    Tip: Set unavailable days to Off and adjust time ranges for
                    each workday.
                  </Typography>
                  <Button
                    variant="contained"
              ...
              >
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Add credentials that boost trust after core profile fields
                      are complete.
                    </Typography>
                  </Box>
                </AccordionSummary>
                    ...
                    <Box>
                      ...
                      {Array.isArray(formData.education) &&
                        formData.education.map((edu, index) => (
                          <Card
                            key={
                              edu.degree + '-' + edu.institution + '-' + index
                            }
                            variant="outlined"
                            sx={{ mb: 1 }}
                          >
              ...
              >
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Include languages you can work in to widen your job
                      opportunities.
                    </Typography>
                  </Box>
                </AccordionSummary>
              ...
              >
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Add photos or samples of past work to increase hirer
                      confidence.
                    </Typography>
                  </Box>
                </AccordionSummary>
                    ...
                    {Array.isArray(formData.portfolio) &&
                      formData.portfolio.map((item, index) => (
                        <Grid
                          ...
                          sm={6}
                          md={4}
                          key={item.id || item._id || item.url || index}
                        >
                          <Card
                            variant="outlined"
                          ...
                          >
                            <CardContent>
                              ...
                              >
                                ...
                                <IconButton
                                  onClick={() =>
                                    handleRemovePortfolioItem(index)
                                  }
                                  color="error"
                              ...
                              <Box sx={{ textAlign: 'center' }}>
                                ...
                                <label htmlFor={`portfolio-image-${index}`}>
                                  <Input
                                    ...
                                    type="file"
                                    inputProps={{
                                      'aria-label': `Upload image for portfolio item ${index + 1}`,
                                    }}
                                    onChange={(e) =>
