    ...
    <Box>
      ...
      <Paper sx={{ p: 2 }}>
        <Alert severity="info" sx={{ mb: 2 }}>
          Add clear before-and-after photos when possible. This helps hirers
          trust your work quality quickly.
        </Alert>
        <input
          type="file"
          multiple
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
          Supported: images and short videos, up to 20MB per file. Use simple
          titles so clients can scan your work fast.
        </Typography>
        {uploadError && (
          <Alert
            severity="error"
