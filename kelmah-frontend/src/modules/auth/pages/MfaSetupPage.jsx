  ...
  const mfaContent = (
    <Box sx={{ width: '100%', maxWidth: 400, mx: 'auto', textAlign: 'center' }}>
      ...
      <Typography
        variant="h5"
        gutterBottom
        sx={isMobile ? { color: 'text.primary', fontWeight: 700 } : {}}
      >
      ...
      {qrCode ? (
        <>
          ...
          <Typography
            variant="body2"
            gutterBottom
            sx={isMobile ? { color: 'text.secondary' } : {}}
          >
            Open Google Authenticator or Authy, scan this code, then enter the
            changing code below.
          </Typography>
          <Box component="form" onSubmit={handleVerify} sx={{ mt: 2 }}>
            ...
            <Button
              ...
              sx={{ minHeight: 48, borderRadius: isMobile ? '24px' : 1 }}
            >
              {verifying ? (
        ...
        >
          ...
          <Typography sx={isMobile ? { color: 'text.secondary' } : {}}>
