    ...
    switch (message.status) {
      ...
      case 'read':
          const selectedConversation = useMemo(() => {
            return sampleConversations.find((conversation) => conversation.id === selectedConversationId);
                ...
                {selectedConversation ? (
                  ...
                  >
                    <Box sx={{ maxWidth: 420 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Open a conversation to see the thread, send a message, or start a new chat from a job or profile.
                      </Typography>
                    </Box>
                  </Paper>
                )}
