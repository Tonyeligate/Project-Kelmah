  ...
  const profileSummary = useMemo(
    () => ({
      ...
      hires:
        ...
        0,
      reviews: statistics?.reviewsGiven || statistics?.reviews || 0,
    }),
    [statistics],
  );
              ...
              >
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Typography color="text.secondary">
                    {profile?.bio ||
                      'Tell workers about your business, how you hire, and the kind of projects you post on Kelmah.'}
                  </Typography>
                </Box>
              </Stack>
            </Grid>
            ...
            <Card sx={{ borderRadius: 3 }}>
              <CardContent>
                ...
                <Typography color="text.secondary" sx={{ mb: 3 }}>
                  Keep your hiring identity current so workers know who they are
                  meeting and what type of jobs you post.
                </Typography>
                ...
                {editing ? (
                  ...
                  <Stack spacing={2.5}>
                    ...
                    <Box>
                      ...
                      <Typography>
                        {profile?.bio ||
                          'Add a short introduction so workers understand your business, preferred communication style, and job expectations.'}
                      </Typography>
                    </Box>
                  </Stack>
                )}
              ...
              <Card sx={{ borderRadius: 3 }}>
                <CardContent>
                  ...
                  {activityItems.length > 0 ? (
                      ...
                      {activityItems.map((item, index) => (
                        <ListItem
                          ...
                          sx={{
                            ...
                            pb: index === activityItems.length - 1 ? 0 : 1.5,
                          }}
                        >
                          <ListItemText
                    ...
                    <Typography color="text.secondary">
                      Activity will appear here after you post jobs, shortlist
                      workers, or update your hiring settings.
                    </Typography>
                  )}
                </CardContent>
              </Card>
              ...
              <Card sx={{ borderRadius: 3 }}>
                <CardContent>
                  ...
                  <Typography color="text.secondary" sx={{ mb: 2 }}>
                    Keep your account aligned with your current jobs so workers
                    see a trustworthy business profile before they respond.
                  </Typography>
                  <Button
                    component={RouterLink}
                    to="/hirer/quick-hire"
