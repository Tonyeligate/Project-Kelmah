...
const ReviewAnalyticsDashboard = () => {
  ...
  */
    ...
    <Grid container spacing={3} sx={{ mb: 4 }}>
      {[
        ...
        },
        {
          ...
          icon: PendingIcon,
          color:
            analytics.overview.moderationBacklog > 20
              ? colors.error
              : colors.success,
          trend:
            analytics.overview.moderationBacklog > 20 ? '+23.1%' : '-12.4%',
        },
        {
          title: 'Quality Score',
          ...
          >
            ...
            >
              <CardContent sx={{ textAlign: 'center', p: 2 }}>
                <metric.icon
                  sx={{ fontSize: 32, color: metric.color, mb: 1 }}
                />
                <Typography
                  variant="h4"
                  sx={{ color: metric.color, fontWeight: 800, mb: 0.5 }}
                >
                  {metric.value}
                </Typography>
                <Typography
  ...
  const QualityMetricsChart = () => {
    const data = Object.entries(analytics.qualityMetrics).map(
      ([key, value]) => ({
                    ...
                    <ListItemText
                      primary={
                        <Stack direction="row" alignItems="center" spacing={1}>
                          ...
                          {worker.recentTrend === 'up' && (
                            <TrendingUpIcon
                              sx={{ color: colors.success, fontSize: 16 }}
                            />
                          )}
                          {worker.recentTrend === 'down' && (
                            <TrendingDownIcon
                              sx={{ color: colors.error, fontSize: 16 }}
                            />
                          )}
                        </Stack>
                      }
