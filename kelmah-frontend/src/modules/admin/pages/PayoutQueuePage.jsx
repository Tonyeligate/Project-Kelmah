...
const PayoutQueuePage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Helmet>
          <title>Payout Queue | Kelmah</title>
        </Helmet>
        <Box
          sx={{
        ...
        >
          ...
          >
            Queue payouts, run a payout batch, and review payout progress in one
            place.
          </Typography>
        </Box>
        ...
        >
          <FormControl size="small" sx={{ minWidth: 140 }}>
            ...
            <Select
              ...
              inputProps={{ 'aria-label': 'Filter payouts by status' }}
            >
          ...
          <TextField
            ...
            onChange={(event) => {
              ...
              if (!Number.isNaN(next) && next >= 1) setPage(next);
            }}
            inputProps={{ min: 1, 'aria-label': 'Payout page number' }}
            sx={{ width: { xs: 88, sm: 100 } }}
          />
          <TextField
            size="small"
            label="Limit"
            ...
            inputProps={{ min: 1, max: 100, 'aria-label': 'Payouts per page' }}
            sx={{ width: { xs: 88, sm: 100 } }}
          />
          <Button
            variant="contained"
        ...
        {loading ? (
          ...
          <Box sx={{ textAlign: 'center', py: 6 }}>
            <Typography color="text.secondary">
              No payout items match your current filters.
            </Typography>
                ...
                <Card variant="outlined">
                  <CardContent sx={{ py: 1.5, '&:last-child': { pb: 1.5 } }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {item.currency === 'GHS' ? 'GH₵' : item.currency || 'GH₵'}
                      {item.amount} • {item.provider}
                    </Typography>
