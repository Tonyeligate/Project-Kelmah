    ...
    <Paper sx={{ p: 3, mb: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          ...
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              Receive updates about new features, promotions, and platform improvements.
            </Typography>
          </Box>
        </Grid>
      </Grid>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box mb={4}>
          ...
          <Typography variant="body1" color="text.secondary">
            Stay updated with real-time notifications about jobs, messages, and payments
          </Typography>
        </Box>
        ...
        <Paper sx={{ p: 3, mt: 3 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Box mb={2}>
                <Chip label="Messages" color="info" size="small" sx={{ mr: 1, mb: 1 }} />
                <Typography variant="body2" display="inline">
                  Chat messages and communication updates
                </Typography>
              </Box>
              <Box mb={2}>
                <Chip label="Jobs" color="success" size="small" sx={{ mr: 1, mb: 1 }} />
                <Typography variant="body2" display="inline">
                  New job opportunities and application updates
                </Typography>
              </Box>
              <Box mb={2}>
                <Chip label="Payments" color="warning" size="small" sx={{ mr: 1, mb: 1 }} />
                <Typography variant="body2" display="inline">
                  Payment confirmations and transaction updates
                </Typography>
              </Box>
              <Box>
                <Chip label="System" color="secondary" size="small" sx={{ mr: 1, mb: 1 }} />
                <Typography variant="body2" display="inline">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" paragraph>
                <strong>Desktop:</strong> Browser notifications when the app is open
              </Typography>
              <Typography variant="body2" paragraph>
                <strong>Email:</strong> Important updates sent to your registered email
              </Typography>
              <Typography variant="body2" paragraph>
                <strong>SMS:</strong> Critical alerts sent to your Ghana phone number
              </Typography>
              <Typography variant="body2">
                <strong>In-App:</strong> Real-time notifications within the platform
              </Typography>
            </Grid>
          </Grid>
        </Paper>
