...
const publicRoutes = [
  ...
  <Route key="/profiles/user/:userId" path="/profiles/user/:userId" element={<UserProfilePage />} />,  
  <Route key="/find-talents" path="/find-talents" element={<WorkerSearchPage />} />,  
  <Route key="/premium" path="/premium" element={<PremiumPage />} />,  
  <Route key="/search/location" path="/search/location" element={<GeoLocationSearch />} />,  
