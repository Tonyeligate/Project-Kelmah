...
export const API_BASE_URL = import.meta.env.VITE_API_URL || SERVICES.AUTH_SERVICE;
...
export const APP_CONFIG = {
  ...
  description: import.meta.env.VITE_APP_DESCRIPTION || 'Connect Vocational Workers with Hirers',
...
export const AUTH_CONFIG = {
  ...
  refreshTokenKey: import.meta.env.VITE_REFRESH_TOKEN_KEY || 'kelmah_refresh_token',
  userKey: import.meta.env.VITE_USER_STORAGE_KEY || 'kelmah_user',
  
  // Token management
  tokenRefreshInterval: parseInt(import.meta.env.VITE_TOKEN_REFRESH_INTERVAL || '1800000'), // 30 min
...
export const WS_CONFIG = {
  ...
  reconnectionAttempts: parseInt(import.meta.env.VITE_WS_RECONNECTION_ATTEMPTS || '5'),
  reconnectionDelay: parseInt(import.meta.env.VITE_WS_RECONNECTION_DELAY || '5000')
};
...
export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    FORGOT_PASSWORD: buildEndpoint(SERVICES.AUTH_SERVICE, '/auth/forgot-password'),
    RESET_PASSWORD: buildEndpoint(SERVICES.AUTH_SERVICE, '/auth/reset-password'),
  ...
  MESSAGING: {
    ...
    CONVERSATIONS: buildEndpoint(SERVICES.MESSAGING_SERVICE, '/messages/conversations'),
