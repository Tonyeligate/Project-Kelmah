...
// Mock subcomponents
jest.mock('../modules/messaging/components/common/MessageList', () => () => <div data-testid="message-list" />);
jest.mock('../modules/messaging/components/common/MessageInput', () => () => <div data-testid="message-input" />);
