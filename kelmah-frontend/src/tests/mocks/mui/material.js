...
export const TextField = ({ label, ...props }) => React.createElement('input', { 'aria-label': label, ...props });
export const Typography = ({ children, ...props }) => React.createElement('span', props, children);
export const Paper = ({ children, ...props }) => React.createElement('div', props, children);
export const Grid = ({ children, ...props }) => React.createElement('div', props, children);
...
export const FormControlLabel = ({ label, control, ...props }) => React.createElement('label', props, [label, control]);
export const Checkbox = (props) => React.createElement('input', { type: 'checkbox', ...props });
export const InputAdornment = ({ children, ...props }) => React.createElement('div', props, children);
export const IconButton = ({ children, ...props }) => React.createElement('button', props, children);
