...
class ContractsApi {
  ...
  async rejectContract(contractId, rejectionData) {
    const response = await apiClient.put(`/contracts/${contractId}/reject`, rejectionData);
    return response.data;
  }
  ...
  async cancelContract(contractId, cancellationData) {
    const response = await apiClient.put(`/contracts/${contractId}/cancel`, cancellationData);
    return response.data;
  }
  ...
  async completeMilestone(contractId, milestoneId) {
    const response = await apiClient.put(`/contracts/${contractId}/milestones/${milestoneId}/complete`);
    return response.data;
  }
  ...
  async createDispute(contractId, disputeData) {
    const response = await apiClient.post(`/contracts/${contractId}/disputes`, disputeData);
    return response.data;
  }
  ...
  async addDisputeMessage(disputeId, messageData) {
    const response = await apiClient.post(`/contracts/disputes/${disputeId}/messages`, messageData);
    return response.data;
  }
