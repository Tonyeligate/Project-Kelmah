/**
 * WorkerProfile Model - shared canonical worker profile access
 * Mirrors the user-service schema so recommendation and discovery flows
 * consume the same worker profile document across services.
 */
