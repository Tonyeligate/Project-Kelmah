...
router.post('/:paymentMethodId/verify', paymentMethodController.verifyPaymentMethod);

// Set a payment method as default
router.put('/:paymentMethodId/default', (req, res, next) => {
  req.body = { isDefault: true };
  next();
}, paymentMethodController.updatePaymentMethod);

router.patch('/:paymentMethodId/default', (req, res, next) => {
  req.body = { isDefault: true };
  next();
}, paymentMethodController.updatePaymentMethod);
