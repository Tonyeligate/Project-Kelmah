...
const connectDB = async () => {
  try {
    ...
    // Using 'connected' instead of 'open' for consistency with auth-service and better reliability on Render
    connectPromise = (async () => {
      ...
      return new Promise((resolve, reject) => {
        ...
        const onConnected = () => {
          ...
          console.log(`✅ User Service connection established and ready for operations: ${conn.connection.host}`);
