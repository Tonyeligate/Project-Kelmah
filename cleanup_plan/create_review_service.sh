#!/bin/bash
# Script to create Review Service microservice structure
...
echo "Creating Review Service microservice structure..."

# Main directory
mkdir -p "$PROJECT_ROOT/kelmah-backend/services/review-service"
cd "$PROJECT_ROOT/kelmah-backend/services/review-service"
...
# Create basic files
echo "Creating basic files for the Review Service..."
...
cat > controllers/review.controller.js << 'EOF'
...
cat > routes/api/review.routes.js << 'EOF'
...
cat > middlewares/asyncHandler.js << 'EOF'
...
echo "Review Service structure created successfully!" 