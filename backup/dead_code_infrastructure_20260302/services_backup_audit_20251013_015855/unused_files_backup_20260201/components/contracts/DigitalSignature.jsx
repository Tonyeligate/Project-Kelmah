  ...
  const getIPAddress = async () => {
    try {
      const response = await fetch(
        `${EXTERNAL_SERVICES.IP_GEOLOCATION}?format=json`,
      );
          ...
          return (
            <Box sx={{ py: 2 }}>
              <Alert severity="info" sx={{ mb: 3 }}>
                Digital signatures in Ghana require identity verification for
                legal validity
              </Alert>
            ...
            <Box sx={{ py: 2 }}>
              ...
              >
                ...
                <Stack spacing={2}>
                  ...
                  <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                    ...
                    conditions outlined in the service agreement. This digital
                    signature will be legally binding under Ghana's Electronic
                    Transactions Act.
                  </Typography>
                </Stack>
              </Paper>
              ...
              <Alert severity="warning">
                <Typography variant="body2">
                  <strong>Important:</strong> Please read all terms carefully
                  before proceeding. This signature will be legally binding and
          ...
          return (
            <Box sx={{ py: 2 }}>
              <Typography variant="body1" sx={{ mb: 3, textAlign: 'center' }}>
                Please sign your name in the box below using your finger or
                stylus
              </Typography>
              ...
              <Alert severity="info">
                <Typography variant="body2">
                  Your signature will be encrypted and stored securely with
                  timestamp and location data for legal verification purposes.
                </Typography>
              </Alert>
            </Box>
          );
    ...
    >
      ...
      <DialogActions sx={{ p: 3, borderTop: '1px solid rgba(255,215,0,0.2)' }}>
        ...
        <Button
          ...
          variant="contained"
          disabled={
            loading || (currentStep === 3 && verificationCode.length !== 6)
          }
          sx={{
